...
export function tmpFileSyncFactory(user : UserContext = {}) : ImplementationDocType {
	const project = {
	...
	return function tmpFileSync(...args: Parameters<ImplementationDocType>) : ReturnType<ImplementationDocType> {
