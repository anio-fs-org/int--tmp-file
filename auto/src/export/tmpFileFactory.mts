...
export function tmpFileFactory(user : UserContext = {}) : ImplementationDocType {
	const project = {
	...
	return async function tmpFile(...args: Parameters<ImplementationDocType>) : ReturnType<ImplementationDocType> {
